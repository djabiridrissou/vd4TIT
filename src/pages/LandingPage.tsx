  ...
  return (
    <>
      <div className="mt-[80px]">
        <Navbar />
        <div className="relative h-[520px] lg:h-[1000px] eledessous">
          <img src="/images/teamsmall.jpg" alt="Team Small" className="w-full h-full object-cover" />
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-green-600 bg-opacity-50">
            <div className="text-center text-white">
              <div className=" lg:flex items-center justify-center">
                <h1 className="text-2xl lg:text-3xl font-bold lg:whitespace-nowrap">Just Like Technology We Never Stop Evolving</h1>
              </div>
              <div className="lg:flex flex-col mt-4 items-center justify-center italic mx-2">
                <h4 className="text-xs lg:text-sm lg:whitespace-nowrap">Our technical expertise is constantly evolving. We are fully proficient in a wide selection of fields and continuously growing.</h4>
              </div>
              <div className="mt-12">
        ...
        <div className="flex flex-col mx-2 -mt-20 lg:mx-80 lg:flex-row">
          <Card className="w-full eledessous">
          ...
          <Card className="w-full bg-green-900 eledessous">
            <div className="flex items-center justify-center flex-col">
        ...
        <div className="bg-slate-100 pb-24 flex items-center justify-center flex-col eledessous">
          ...
          <div className="mt-6 text-2xl font-semibold text-green-800 flex flex-col items-center justify-center lg:flex-row lg:justify-center lg:items-center">
